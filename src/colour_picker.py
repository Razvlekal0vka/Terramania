...
"""================================================================================================================= 
    ...
    Хранит информацию о палитре цветов
-----------------------------------------------------------------------------------------------------------------"""
...
class ColourPicker:
    ...
    def render_surface(self):
        ...
        # Draw border
        pygame.draw.rect(self.surface, (90, 90, 90),
                         Rect(0, 0, self.width + self.border_size * 2, self.height + self.border_size * 2), 0)
        pygame.draw.rect(self.surface, (128, 128, 128),
                         Rect(2, 2, self.width + self.border_size * 2 - 4, self.height + self.border_size * 2 - 4), 0)
        pygame.draw.rect(self.surface, (110, 110, 110),
                         Rect(4, 4, self.width + self.border_size * 2 - 8, self.height + self.border_size * 2 - 8), 0)
    ...
    """================================================================================================================= 
        colour_picker.ColourPicker.get_colour -> кортеж

        Создает цвет поверхности в заданном месте
    -----------------------------------------------------------------------------------------------------------------"""
    ...
    """================================================================================================================= 
        ...
        Если щелкнуть мышью по палитре цветов, обновите выбранный цвет и местоположение.
    -----------------------------------------------------------------------------------------------------------------"""
    ...
    def update(self):
        if pygame.mouse.get_pressed()[0] and not commons.WAIT_TO_USE:
            if self.rect.collidepoint(commons.MOUSE_POS):
                ...
                self.selected_colour[0] * 0.5, self.selected_colour[1] * 0.5, self.selected_colour[2] * 0.5)

    """================================================================================================================= 
        colour_picker.ColourPicker.draw -> void

        Рисует поверхность палитры цветов и указывает местоположение выбранного цвета.
    -----------------------------------------------------------------------------------------------------------------"""
    ...
    def draw(self):
        ...
        if self.selected_x is not None and self.selected_y is not None:
            pygame.draw.circle(commons.screen, (128, 128, 128), (self.selected_x + self.position[0] + self.border_size,
