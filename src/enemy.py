...
"""================================================================================================================= 
    ...
    Хранит всю информацию о вражеском экземпляре
-----------------------------------------------------------------------------------------------------------------"""
...
class Enemy:
    ...
    """================================================================================================================= 
        ...
        Обновляет инстанс врага, выполняя физику, AI и анимацию
    -----------------------------------------------------------------------------------------------------------------"""
    def update(self):
        if self.alive:
    ...
    """================================================================================================================= 
        ...
        Наносит урон инстансу врага, порождая частицы и воспроизводя звук
        
        Призовет убить врага, если его здоровье упадет ниже 0 
    -----------------------------------------------------------------------------------------------------------------"""
    ...
    """================================================================================================================= 
        ...
        Устанавливает для переменной «живые враги» значение false, будет удалено из списка сущностей менеджером.
        
        Воспроизводит звук и порождает частицы и добычу
    -----------------------------------------------------------------------------------------------------------------"""
    ...
    """================================================================================================================= 
        ...
        Обновляет кадр анимации экземпляра врага
    -----------------------------------------------------------------------------------------------------------------"""
    def animate(self):
        if not self.grounded:
    ...
    """================================================================================================================= 
        ...
        Проверяет, не ушел ли противник слишком далеко за пределы поля зрения игрока, если да, вернуть true
    -----------------------------------------------------------------------------------------------------------------"""
